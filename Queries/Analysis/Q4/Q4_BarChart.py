...
csvFile = pd.read_csv('./Queries/Analysis/Q4/Q4.csv', sep=',', names=['RepositoryName','CommitId', 'NumOfModifiedFiles'],
                      skiprows=1)
...
barChartData = pd.cut(modifiedFilesDf, [0,3,6,10,np.inf], labels=['(0-2]','(2-5]','(5-10]','(10+]'])
